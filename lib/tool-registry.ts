...
const allTools: ToolMeta[] = [
  ...
  { title: "Ảnh công thức & hình học → LaTeX/TikZ", description: "Chuyển ảnh công thức thành LaTeX hoặc ảnh hình học đã cắt gọn thành mã TikZ.", href: "/tools/image-to-latex", category: "formula-latex", popular: true, badge: "Ảnh" },
