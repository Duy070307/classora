...
export const sampleExamInput: ExamInput = {
  schoolName: "Trường THCS Classora", teacherName: "Nguyễn Thị Lan", subject: "Toán", grade: "8",
  topic: "Phương trình bậc nhất một ẩn", duration: "45 phút", examType: "Kết hợp",
  multipleChoiceCount: 8, essayCount: 3, totalScore: 10, level: "Trung bình",
  recognitionRate: 30, understandingRate: 40, applicationRate: 20, advancedRate: 10,
...
export const sampleWorksheetInput: WorksheetInput = {
  subject: "Ngữ văn", grade: "6", topic: "Truyện đồng thoại",
  objective: "Học sinh nhận biết nhân vật, chi tiết tiêu biểu và rút ra bài học từ văn bản.",
  exerciseCount: 5, level: "Vừa", includeAnswers: true, style: "Dễ hiểu",
  extraRequirements: "Có chỗ trống đủ để học sinh trình bày."
};

export const sampleStudentCommentInput: StudentCommentInput = {
  studentName: "Nguyễn Minh An", className: "7A1", role: "Giáo viên chủ nhiệm", performance: "Khá",
  attitude: "tích cực tham gia hoạt động và hợp tác với bạn", strengths: "có ý thức học tập, trình bày vở cẩn thận",
  limitations: "cần kiểm tra kỹ bài làm trước khi nộp", tone: "Nhẹ nhàng", purpose: "Nhận xét cuối kỳ"
};

export const sampleLessonPlanInput: GenericToolInput = {
  subject: "Toán", grade: "8", lessonName: "Phương trình bậc nhất một ẩn", duration: "45 phút",
  objectives: "Học sinh nhận biết phương trình bậc nhất, giải được bài tập cơ bản và vận dụng vào tình huống thực tế.",
  methods: "Gợi mở, thảo luận nhóm, luyện tập cá nhân", materials: "Sách giáo khoa, bảng phụ, phiếu học tập",
  extraRequirements: "Có hoạt động kiểm tra nhanh cuối bài."
};

export const sampleMatrixInput: GenericToolInput = {
  subject: "Ngữ văn", grade: "6", topic: "Truyện đồng thoại", duration: "45 phút",
  totalScore: 10, questionCount: 12, recognitionRate: 30, understandingRate: 40,
  applicationRate: 20, advancedRate: 10, notes: "Ưu tiên đọc hiểu và một câu vận dụng viết đoạn ngắn."
};
...
export const sampleAnswerKeyInput: GenericToolInput = {
  ...
  totalScore: 10, answerStyle: "Có lời giải từng bước", extraRequirements: "Thang điểm rõ từng ý."
};

export const sampleExamShufflerInput: GenericToolInput = {
  examName: "Đề kiểm tra 15 phút", subject: "Toán", grade: "8", codeCount: 4,
  questions: "Câu 1. Kết quả của 2 + 3 là?\nA. 4\nB. 5\nC. 6\nD. 7\nĐáp án: B\n\nCâu 2. Số nào là số chẵn?\nA. 3\nB. 5\nC. 8\nD. 9\nĐáp án: C",
  shuffleQuestions: true, shuffleAnswers: true, notes: "Tạo bốn mã đề để kiểm thử."
};
...
export const sampleTemplates: TemplateItem[] = [
  { id: "sample-template-exam", name: "Mẫu đề kiểm tra cơ bản", type: "Đề kiểm tra", content: "{{ten_truong}}\nGiáo viên: {{ten_giao_vien}}\nNăm học: {{nam_hoc}}\n\nMôn: {{mon_hoc}} - Lớp: {{lop}}\nChủ đề: {{chu_de}}\n\n{{noi_dung}}", notes: "Mẫu demo có header trường và giáo viên.", updatedAt: new Date().toISOString() },
  { id: "sample-template-worksheet", name: "Mẫu phiếu học tập", type: "Phiếu học tập", content: "{{ten_truong}}\nPHIẾU HỌC TẬP - {{mon_hoc}} {{lop}}\n\n{{noi_dung}}", notes: "Dùng để kiểm thử placeholder.", updatedAt: new Date().toISOString() }
];

export const sampleSettings: DocumentSettings = {
  schoolName: "Trường THCS Classora", teacherName: "Nguyễn Thị Lan", department: "Tổ Toán - Tin",
  schoolYear: "2026-2027", fontFamily: "Times New Roman", fontSize: "13"
};
