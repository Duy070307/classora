...
export const sampleWorksheetInput: WorksheetInput = {
  ...
  objective:
    "Học sinh nhận biết nhân vật, chi tiết tiêu biểu và rút ra bài học từ văn bản.",
  exerciseCount: 5,
  level: "Vừa",
  includeAnswers: true,
  style: "Dễ hiểu",
...
export const sampleLessonPlanInput: GenericToolInput = {
  ...
  duration: "45 phút",
  objectives:
    "Học sinh nhận biết phương trình bậc nhất, giải được bài tập cơ bản và vận dụng vào tình huống thực tế.",
...
export const sampleQuestions: QuestionItem[] = [
  {
    ...
    answer: "A",
    explanation: "Phương trình có dạng ax + b = 0 với a khác 0.",
  ...
  },
  {
    ...
    grade: "6",
    topic: "Truyện đồng thoại",
    question: "Nêu hai đặc điểm của nhân vật trong truyện đồng thoại.",
    type: "Tự luận",
    difficulty: "Thông hiểu",
    answer:
      "Nhân vật thường là loài vật được nhân hóa và mang đặc điểm con người.",
    explanation: "Chấp nhận cách diễn đạt tương đương.",
    createdAt: new Date().toISOString(),
  },
];
...
export const sampleTemplates: TemplateItem[] = [
  {
    id: "sample-template-exam",
    name: "Mẫu đề kiểm tra của trường",
    type: "Đề kiểm tra",
    content:
      "{{ten_truong}}\nTổ/Bộ môn: {{to_bo_mon}}\nGiáo viên: {{ten_giao_vien}}\nNăm học: {{nam_hoc}}\n\nĐỀ KIỂM TRA\nMôn: {{mon_hoc}} - Lớp: {{lop}}\nChủ đề: {{chu_de}}\nThời gian: {{thoi_gian}}\n\nHọ và tên: ....................................  Lớp: ............\n\n{{noi_dung}}",
    notes:
      "Mẫu tham khảo có header trường, tổ bộ môn và dòng thông tin học sinh.",
    updatedAt: new Date().toISOString(),
  },
  {
    id: "sample-template-worksheet",
    name: "Mẫu phiếu học tập",
    type: "Phiếu học tập",
    content:
      "{{ten_truong}}\nPHIẾU HỌC TẬP - {{mon_hoc}} {{lop}}\nChủ đề: {{chu_de}}\n\nHọ tên: .................................... Lớp: ............\n\nMục tiêu:\n{{ghi_chu}}\n\n{{noi_dung}}\n\nKhu vực trả lời:\n................................................................................",
    notes: "Dùng để kiểm thử placeholder phiếu học tập.",
    updatedAt: new Date().toISOString(),
  },
];
...
export function loadSampleQuestionBank() {
  return writeJson(STORAGE_KEYS.questions, sampleQuestions);
}
export function loadSampleTemplates() {
  return writeJson(STORAGE_KEYS.templates, sampleTemplates);
}
export function loadSampleSettings() {
  return writeJson(STORAGE_KEYS.settings, sampleSettings);
}
export function clearAllDemoData() {
  return clearClassoraStorage();
}
export function resetDemoData() {
  clearAllDemoData();
  return (
    loadSampleQuestionBank() && loadSampleTemplates() && loadSampleSettings()
  );
}
