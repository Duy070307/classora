...
export const expandedToolConfigs: ToolConfig[] = [
  {
    ...
    fields: [
      ...
      { name: "bloomLevel", label: "Mức độ mục tiêu ưu tiên", type: "select", options: ["Cơ bản", "Vận dụng", "Vận dụng cao", "Đầy đủ theo Bloom"], helperText: "Mức này định hướng cách viết mục tiêu đo được và hoạt động học tập.", defaultValue: "Đầy đủ theo Bloom" },
      { name: "objectives", label: "Mục tiêu bài học", type: "textarea", defaultValue: "Học sinh trình bày được khái niệm, vận dụng được kiến thức vào bài tập cơ bản và giải thích được một tình huống thực tế." },
