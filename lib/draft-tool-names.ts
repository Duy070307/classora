export const draftToolNames: Record<string, string> = {
  "/tools/exam-generator": "Tạo đề kiểm tra",
  "/tools/matrix-generator": "Tạo ma trận đề",
  "/tools/answer-key-generator": "Tạo đáp án và thang điểm",
