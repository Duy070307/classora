...
const sections = [
  ...
  ["Nên thử điều gì?", "Chọn công cụ phù hợp, tạo bản nháp, xuất Word/PDF và rà soát trước khi dùng.", FileDown],
];
...
export default function PrivateBetaPage() {
  return <main><Navbar /><section className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
    ...
    <section className="mt-8 rounded-2xl border border-amber-200 bg-amber-50 p-5"><h2 className="font-bold text-amber-900">Giới hạn hiện tại</h2><p className="mt-2 text-sm leading-6 text-amber-800">Dữ liệu lưu trên trình duyệt và mọi nội dung cần được giáo viên kiểm tra lại trước khi sử dụng.</p></section>
    <div className="mt-8 flex flex-wrap gap-3"><Link href="/tools" className="btn-secondary">Xem tất cả công cụ</Link><Link href="/share" className="btn-secondary">Chia sẻ Soạn Lab</Link><Link href="/getting-started" className="btn-secondary">Hướng dẫn sử dụng</Link></div>
