...
export default function PrivateBetaPage() {
  return <main><Navbar /><section className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
    <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 p-7 text-white shadow-2xl shadow-blue-200 sm:p-10"><span className="rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-bold">Trải nghiệm sản phẩm</span><h1 className="mt-5 text-4xl font-extrabold sm:text-5xl">Khám phá Soạn Lab</h1><p className="mt-4 max-w-3xl text-lg leading-8 text-blue-100">Trải nghiệm quy trình tạo tài liệu, lưu lịch sử và xuất Word/PDF dành cho giáo viên.</p><div className="mt-7 flex flex-wrap gap-3"><Link href="/dashboard" className="inline-flex min-h-11 items-center rounded-xl bg-white px-5 py-2 text-sm font-bold text-blue-700">Mở dashboard</Link><Link href="/feedback" className="inline-flex min-h-11 items-center rounded-xl border border-white/30 px-5 py-2 text-sm font-bold">Gửi góp ý</Link></div></div>
