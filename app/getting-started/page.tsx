...
const steps = [
  ...
  ["05", "Góp ý", "Chia sẻ trải nghiệm để Soạn Lab cải thiện theo nhu cầu thực tế."]
];
const tools = [
...
export default function GettingStartedPage() {
  return <div className="min-h-screen md:flex"><Sidebar /><main className="flex-1 p-5 md:p-8">
    <PageHeader title="Bắt đầu với Soạn Lab" description="Năm bước ngắn để tạo tài liệu đầu tiên trong bản demo." />
