...
export default function ReleaseCandidatePage() {
  ...
  return <main className="warm-page min-h-screen"><Navbar /><section className="mx-auto max-w-6xl px-4 py-10 sm:py-14">
    ...
    <div className="mt-7 flex flex-wrap gap-3"><Link href="/dashboard" className="btn-primary">Mở dashboard</Link><Link href="/tools" className="btn-secondary">Mở tất cả công cụ</Link><Link href="/samples" className="btn-secondary">Mẫu sử dụng</Link><Link href="/demo-checklist" className="btn-secondary">Kiểm tra chi tiết</Link><Link href="/known-issues" className="btn-secondary">Trạng thái hệ thống</Link></div>
