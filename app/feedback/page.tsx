...
${browserNote}`;
  ...
  return <main className="min-h-screen"><Navbar /><section className="mx-auto max-w-5xl px-4 py-10 md:py-14"><div className="mb-8"><p className="text-sm font-bold uppercase tracking-wide text-brand">Private beta feedback</p><h1 className="mt-2 text-3xl font-bold text-ink md:text-4xl">Góp ý cho Soạn Lab</h1><p className="mt-4 max-w-3xl leading-7 text-muted">Soạn Lab hiện là bản MVP/demo chưa sử dụng AI thật. Góp ý của thầy cô giúp đánh giá độ dễ dùng, workflow và chất lượng file Word trước khi phát triển bản beta.</p></div>
