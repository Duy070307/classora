...
export default function PricingPage() {
  return (
    <div className="min-h-screen md:flex"><Sidebar /><main className="flex-1 p-5 md:p-8">
      <PageHeader title="Bảng giá dự kiến" description="Các mức giá dưới đây chỉ dùng để kiểm thử mô hình sản phẩm. Soạn Lab hiện chưa thu phí." />
      ...
      <p className="mt-5 rounded-md border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">Bảng giá chỉ là dự kiến để kiểm thử mô hình sản phẩm. Soạn Lab hiện chưa thu phí.</p>
    </main></div>
  );
}
