...
export default function DemoDataPage() {
  ...
  return <div className="min-h-screen md:flex"><Sidebar /><main className="flex-1 p-4 sm:p-5 md:p-8">
    <PageHeader title="Dữ liệu demo" description="Trang này giúp nạp dữ liệu mẫu để kiểm thử Classora nhanh hơn." />
    <section className="card max-w-3xl space-y-4 p-5">
      ...
      <button className="btn-secondary text-red-600" onClick={() => { if (window.confirm("Xóa toàn bộ dữ liệu Classora trên trình duyệt này?")) run(clearAllDemoData, "Đã xóa toàn bộ dữ liệu demo."); }}><Eraser size={17} />Xóa toàn bộ dữ liệu demo</button>
