...
const issues = [
  ...
  "D? li?u c? th? ph? thu?c v?o t?i kho?n ho?c thi?t b? ?ang s? d?ng; n?n xu?t b?n sao l?u ??nh k?.",
...
export default function KnownIssuesPage() {
  return <main className="min-h-screen"><Navbar /><section className="mx-auto max-w-4xl px-4 py-10 sm:py-16">
    <div className="rounded-3xl border border-amber-200 bg-gradient-to-br from-amber-50 to-white p-6 sm:p-9">
      <div className="flex items-center gap-3"><AlertCircle className="text-coral" /><p className="text-sm font-bold uppercase tracking-wide text-coral">Lưu ý sử dụng</p></div>
