...
<head>
  ...
  <style>
    html, body { margin: 0; height: 100%; overflow: hidden; font-family: Arial, sans-serif; background: #f8fafc; color: #0f172a; }
    #scene { width: 100vw; height: 100vh; display: block; }
    .panel { position: fixed; left: 14px; top: 14px; max-width: 330px; border: 1px solid #dbeafe; border-radius: 16px; background: rgba(255,255,255,.92); padding: 12px 14px; box-shadow: 0 12px 30px rgba(15,23,42,.08); }
    .panel h1 { margin: 0 0 6px; font-size: 16px; }
    .panel p { margin: 0; font-size: 13px; line-height: 1.45; color: #475569; }
    .controls { position: fixed; left: 14px; bottom: 14px; display: flex; gap: 10px; align-items: center; border: 1px solid #dbeafe; border-radius: 999px; background: rgba(255,255,255,.92); padding: 10px 12px; }
