...
type Status = { storage: boolean; history: number; templates: number; questions: number; drafts: number; plan: string; usage: number; settings: boolean; keys: string[] };
...
export default function DiagnosticsPage() {
  const [status, setStatus] = useState<Status>({ storage: false, history: 0, templates: 0, questions: 0, drafts: 0, plan: "Free demo", usage: 0, settings: false, keys: [] });
