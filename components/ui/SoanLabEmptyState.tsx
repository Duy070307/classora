...
export function SoanLabEmptyState({ title = "Chưa có dữ liệu", description = "Khi bạn bắt đầu sử dụng Soạn Lab, nội dung sẽ xuất hiện tại đây.", action }: { title?: string; description?: string; action?: React.ReactNode }) {
  return (
    <section className="rounded-[2rem] border border-dashed border-blue-200 bg-gradient-to-br from-white via-white to-blue-50/70 p-6 text-center shadow-sm sm:p-8">
      <SoanLabIllustration variant="empty" className="max-w-xs" />
