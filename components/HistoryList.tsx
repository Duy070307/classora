      ...
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
        {filteredItems.length ? (
          filteredItems.map((item) => (
            <article
              key={item.id}
              className={`min-w-0 rounded-2xl border bg-white p-4 shadow-sm transition hover:border-emerald-200 hover:shadow-md ${selected.includes(item.id) ? "border-emerald-400 bg-emerald-50/50 ring-2 ring-emerald-100" : "border-slate-200"}`}
            >
