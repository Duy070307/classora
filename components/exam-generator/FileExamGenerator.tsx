    ...
    <div className="grid min-w-0 gap-5 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
      <section className="tool-form-card min-w-0">
        {!blueprint ? <>
          ...
          <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4 text-sm leading-6 text-cyan-950"><strong>Đề chụp hoặc PDF quét?</strong> Hãy dùng <Link href="/tools/document-recognition" className="font-black text-blue-700 underline">Đọc đề từ ảnh/PDF</Link> để nhận dạng và rà soát từng trang trước.</div>
