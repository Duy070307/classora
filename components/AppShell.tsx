...
export function AppShell({ children, title, contentClassName = "mx-auto w-full max-w-[1500px] p-4 sm:p-6 lg:p-8" }: { children: React.ReactNode; title?: string; contentClassName?: string }) {
