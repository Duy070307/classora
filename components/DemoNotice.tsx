  ...
  return (
    <div className={`rounded-md border border-amber-200 bg-amber-50 text-amber-800 ${compact ? "px-3 py-2 text-xs" : "px-4 py-3 text-sm"}`}>
      <div className="flex gap-2">
        ...
        <p>Classora hiện là bản MVP/demo dùng AI mô phỏng. Nội dung thật sẽ được kích hoạt ở bản beta. <Link href="/feedback" className="font-bold underline">Góp ý</Link></p>
      </div>
    </div>
  );
}
