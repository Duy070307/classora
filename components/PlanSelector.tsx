  ...
  return (
    <div>
      ...
      <div className="mt-2 inline-flex rounded-md border border-line bg-slate-50 p-1">
        ...
        <button type="button" onClick={() => change("pro")} className={`rounded px-4 py-2 text-sm font-semibold ${plan === "pro" ? "bg-emerald-600 text-white shadow-sm" : "text-muted"}`}>Cá nhân</button>
      </div>
