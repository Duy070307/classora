...
export function ToolPageHeader({ title, description, category = "Công cụ giáo viên", iconName, exportable = true, accent }: { title: string; description: string; category?: string; iconName?: SoanLabIconName; exportable?: boolean; accent?: ToolAccentTone }) {
